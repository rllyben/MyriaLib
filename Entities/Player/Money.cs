...
namespace MyriaLib.Entities.Players
{
    ...
    /// Denomination ladder: Bronze → Silver (1,000 B) → Gold (1,000 S) → Platinum (100 G) → Coin Crystal (100 Pt).
    /// </summary>
    public readonly struct Money : IComparable<Money>, IEquatable<Money>, IFormattable
    {
        ...
        /// <summary>
        /// Formats the money amount.
        /// "S" (default) — short form, skips leading zero groups, always shows bronze.
        /// "L" — long form with full denomination names.
        /// "C" — compact, most significant two non-zero units.
        /// "B" — raw bronze total.
        /// </summary>
